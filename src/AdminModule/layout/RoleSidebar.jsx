...
const navItems = [
  {
    ...
    label: "Overview",
    href: "/adminDashboard",
    matchPaths: ["/adminDashboard"],

  },
  {
    icon: Person ,
    label: "Leads Data",
    href: "/adminLeadDataList",
    matchPaths: ["/adminLeadDataList","/adminUploadDataList","/adminViewDataList","/adminEditDataList"],
...
const RoleSidebar = () => {
  ...
  return (
    <div className="flex flex-col h-full  border-gray-200 bg-[#fff]">
      <div className="p-6">
        ...
        {navItems.map((item) => {
          ...
          return (
            <NavLink
              ...
              to={item.href}
              className={cn(
                "flex items-center px-3 py-2 text-[16px] rounded-[16px]",
