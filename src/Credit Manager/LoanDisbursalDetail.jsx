                ...
                <div className="viewLeadsCont">
                    ...
                    <div className="followUpCard card">
                        <div className="followUpHeader">
                            <h3 className="teleHeading">Follow up History</h3>
                            <button className="teleBtn" onClick={handleAddNewFollowUp}>
                                Add Next Follow-up
                            </button>
                        </div>
...
export default LoanDisbursalDetail;
