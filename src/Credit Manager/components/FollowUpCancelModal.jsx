...
const FollowUpCancelModal = ({ onClose, onConfirm }) => {
    const [selectedReason, setSelectedReason] = useState('');

    return (
        <div className="fixed inset-0 flex items-center justify-center bg-white/30 backdrop-blur-sm px-4">
            <div className="bg-white w-full max-w-md rounded-2xl p-6 shadow-lg">
                <h2 className="text-[20px] font-semibold mb-1" style={{ color: '#16151C' }}> Cancellation</h2>
                <select
...
export default FollowUpCancelModal;
