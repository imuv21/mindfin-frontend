...
const SelectBankModal = ({ onClose, onConfirm }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4">
            <div className="bg-white w-full max-w-md rounded-2xl p-6 shadow-2xl z-60">
                <h2 className="text-[20px] font-semibold mb-1 text-[#16151C]">Select Bank for loan</h2>
                ...
                >
                    ...
                    <option value="HDFC" className="text-sm text-gray-600 font-medium">HDFC</option>
