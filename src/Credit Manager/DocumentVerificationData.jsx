...
import { formatCurrency, statusDisplay, statusColors } from '../components/utils';
...
const DocumentVerificationData = () => {
    ...
    const tableColumns = [
        "Lead Name", "Phone Number", "Alternate Number", "Gmail", "Loan Amount", "Loan Type", "Balance Sheet", "GST Returns", "ITR", "Status", "Upload", "Option"
    ];
    ...
    const goToVerify = (id) => {
        navigate(`/document-verification/${id}`);
    }
                ...
                <div className="leadsTableCont border">
                                        ...
                                        <tr key={lead._id}>
                                            ...
                                            <td className="teleText">
                                                <div className="verifyBox">
                                                    <button className="teleText">Verified</button>
                                                    <button className='recheckBtn' onClick={() => goToVerify(lead._id)}>Recheck</button>
                                                </div>
                                            </td>
                                            <td className="teleText">
                                                <div className="verifyBox">
                                                    <button className='recheckBtn' onClick={() => goToVerify(lead._id)}>Verify</button>
                                                </div>
                                            </td>
                                            <td className="teleText">
                                                <div className="verifyBox">
                    ...
                    <div className="telePaginationRow">
                        ...
                        <div className="telePagination">
                            ...
                            {creditPagination && creditPagination.totalPages > 0 && (
                                <>
                                    {Array.from({ length: Math.min(5, creditPagination.totalPages) }, (_, i) => {
                                        let pageNum;
                                        if (creditPagination.totalPages <= 5) {
                                            pageNum = i + 1;
                                        } else if (page <= 3) {
                                            pageNum = i + 1;
                                        } else if (page >= creditPagination.totalPages - 2) {
                                            pageNum = creditPagination.totalPages - 4 + i;
                                        } else {
                                            pageNum = page - 2 + i;
                                        }
                                    ...
                                    {creditPagination.totalPages > 5 && page < creditPagination.totalPages - 2 && (
                                        <span className="telePageDots">...</span>
                                    )}

                                    {creditPagination.totalPages > 5 && page < creditPagination.totalPages - 2 && (
                                        <button
                                            className={`telePageBtn ${page === creditPagination.totalPages ? 'telePageActive' : ''}`}
                                            onClick={() => setPage(creditPagination.totalPages)}
                                            disabled={creditLoading}
                                        >
...
export default DocumentVerificationData;